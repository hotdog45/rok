...
class MyMethodChannel {
  static const methodChannel =
      const MethodChannel('com.yp.flutter.method/plugin');
  ...
  static const String GET_APP_VERSION_NAME = "yp://flutterToNativeGetAppVersionName";
  ...
  static const String GET_MERCHANT_SCOPE = "yp://flutterToNativeGetMerchantScope";
  ...
  //去web购物车
  static const String GO_WEB_SHOPPING_CART_PAGE = "yp://webViewShoppingCartPage";
  ...
  //去订单列表页
  static const String GO_FREE_SHIP_ORDER_LIST_PAGE = "yp://nativeFreeShipOrderListPage";
...
///-----------------------flutter-------------------------------
  ...
  //全国包邮首页
  static const String FLUTTER_FREE_SHIPPING_PAGE = "yp://nativeFreeShippingPage";
  //商品详情页
  static const String FLUTTER_FREE_SHIPPING_PRODUCT_DETAIL_PAGE = "yp://nativeFreeShippingProductDetailPage";
  //品牌详情详情
  static const String FLUTTER_BRAND_DETAIL_PAGE = "yp://nativeBrandDetailPage";
  //包邮售后类型选择页面
  static const String FLUTTER_INIT_REFUND_ORDER_PAGE = "yp://flutterInitRefundOrderPage";
  //包邮售后提交页面
  static const String FLUTTER_SUBMIT_REFUND_ORDER_PAGE = "yp://flutterSubmitRefundOrderPage";
  //包邮售后提交成功
  static const String FLUTTER_SUBMIT_REFUND_ORDER_SUCCESS = "yp://flutterSubmitRefundOrderSuccess";
  //商品弹窗
  static const String FLUTTER_PRODUCT_DETAIL_DIALOG = "yp://flutterProductDetailDialog";
  //分享弹窗
...
//测试通信
  static const String GO_TEST_MethodChannelPage = "yp://flutterMethodChannelPage";
  ...
  static Future<String> onPressCallback(String route,
    ...
    try {
      ...
      final String callbackResult =
          await methodChannel.invokeMethod(route);
