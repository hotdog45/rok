...
class KLineMainStateModel {
  ...
  static List<KLineMainStateModel> defaultModels() {
    var model1 =
        KLineMainStateModel(state: MainState.MA, name: "MA", isSelect: true);
    var model2 = KLineMainStateModel(
        state: MainState.BOLL, name: "BOLL", isSelect: false);
...
class KLineSecondaryStateModel {
  ...
  static List<KLineSecondaryStateModel> defaultModels() {
    var model1 = KLineSecondaryStateModel(
        state: SecondaryState.MACD, name: "MACD", isSelect: true);
    var model2 = KLineSecondaryStateModel(
        state: SecondaryState.KDJ, name: "KDJ", isSelect: false);
    var model3 = KLineSecondaryStateModel(
        state: SecondaryState.RSI, name: "RSI", isSelect: false);
    var model4 = KLineSecondaryStateModel(
        state: SecondaryState.WR, name: "WR", isSelect: false);
