...
class _KLineVerticalWidgetState extends State<KLineVerticalWidget>
  ...
  void initState() {
    ...
    timeAnimationController = AnimationController(vsync: this);
    timePosition = RectTween(
      begin: Rect.fromLTRB(0.0, -40, 0, 0.0),
      end: Rect.fromLTRB(0.0, 5.0, 0.0, 0.0),
    );
    timeRect = timePosition.animate(timeAnimationController);

    indicatorsAnimationController = AnimationController(vsync: this);
    indicatorsPosition = RectTween(
      begin: Rect.fromLTRB(0.0, -100, 0, 0.0),
      end: Rect.fromLTRB(0.0, 5.0, 0.0, 0.0),
    );
              ...
              children: <Widget>[
                    ...
                    child: TabBar(
                      ...
                      onTap: (int index) {
                        if (index == dataController.topPeriodItems.length - 1) {
                          ...
                          hidePeriod();
                          hideindicators();
                          KLineDataWidgetController.of(context).changePeriod(
                ...
                Expanded(
                  ...
                  child: IconButton(
                      ...
                      onPressed: indicatorsShowOrHide),
                ))
              ],
            ),
          ),
